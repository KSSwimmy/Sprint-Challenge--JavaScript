...
-.forEach changes information within an array where as .map will do the same but return a new array.

2. What is the difference between a function and a method?

A function returns a value applying to its inputs a method applys mainly to an object on which it is called.
...
*Window/Global Object Binding: Whenever a function is called by a preceding dot, the object before that dot is this.
